...
export default function HomePage() {
  ...
  // Geometric lines opacity - fade out later to give hero more static time
  const linesOpacity = useTransform(scrollYProgress, [0.4, 0.5], [1, 0])

  // Mission section position - slides up later with more static time between hero and mission
  const missionY = useTransform(scrollYProgress, [0.6, 0.75], [100, 0])
  
  // Mission 2 section position - slides up after mission has static time
  const mission2Y = useTransform(scrollYProgress, [0.9, 1.0], [100, 0])
  ...
  return (
    <div className="relative">
      ...
      {/* Pin spacer equivalent - increased height for extended transitions */}
      <div className="relative" style={{ marginBottom: "5000px", height: "2500px" }}>
